...
const MyOrders = () => {
  ...
  return (
    <div className="min-h-screen bg-app-cream mb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 1g:px-8 py-8">
            ...
            {orders.map((order) => (
              <Link key={order._id} to={`/orders/${order._id}`} className="block max-w-4xl bg-white rounded-2xl p-5 hover:shadow transition-all">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  {order.items.length > 4 && <div className="sie-12 sm:size-16 rounded-lg bg-app-cream flex-center text-sm font-semibold text-app-text-light">+{order.items.length - 4}</div>}
                </div>
