...
const FilterPanel = ({ categories, category, minPrice, maxPrice, updateFilter, clearFilters, hasFilters }: any) => {
    ...
    return (
        <div className="space-y-6">
            {/* Categories */}
            <div>
                <h3 className="text-sm font-semibold text-app-green mb3">Categories</h3>
            ...
            {/* Price Range */}
            <div>
                <h3 className="text-sm font-semibold text-app-green mb3">Price Range</h3>
            ...
            {hasFilters && (
                ...
                className="w-full py-2 text-sm text-app-error hover:bg-red-50 rounded-1g transition-colors font-medium">
                    Clera All Filters
                </button>
            )}
        </div>
